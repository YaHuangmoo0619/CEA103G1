...
<%int flwed_mbr_no = Integer.parseInt(request.getParameter("flwed_mbr_no")); %>
<%
  FollowService followSvc = new FollowService();

  List<FollowVO> list = followSvc.findbyflwed(flwed_mbr_no);
