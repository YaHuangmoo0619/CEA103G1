...
<!-- 				</tr> -->
				...
				<c:if test="${param.where.equals('rcpt') && memberVO.mbr_no == member_mailVO.rcpt_no && member_mailVO.mail_stat == 0}">
...
<%-- 					</c:if> --%>
					<c:if test="${param.where.equals('send') && memberVO.mbr_no == member_mailVO.send_no && member_mailVO.mail_stat == 1}">
<%-- 					<c:if test="${(memberVO.mbr_no == member_mailVO.rcpt_no && member_mailVO.mail_stat == 1) || (memberVO.mbr_no == member_mailVO.send_no && member_mailVO.mail_stat == 0)}"> --%>
					<tr>
						<td style="display:none;">${member_mailVO.mail_no}</td>
