...
public class Place_OrderService {
	...
	public Place_OrderVO addPlace_Order(Integer mbr_no, Integer camp_no, Timestamp plc_ord_time, Date ckin_date,
		...
		place_orderVO.setPlc_ord_time(plc_ord_time);
