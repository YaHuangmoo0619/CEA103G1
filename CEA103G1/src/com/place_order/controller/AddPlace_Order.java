...
System.out.println("營位數量:" + plc_amt);	
		...
		Place_OrderVO place_orderVO = place_orderSvc.addPlace_Order(mbr_no, camp_no, ckin_date, ckout_date, plc_amt, plc_ord_sum, ex_ppl, pay_meth, pay_stat, used_pt, receipt, rmk, list);
