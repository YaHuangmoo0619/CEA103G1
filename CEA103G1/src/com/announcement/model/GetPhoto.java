...
@WebServlet("/announcement/GetPhoto")
public class GetPhoto extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			String an_no = req.getParameter("an_no").trim();
			ResultSet rs = stmt.executeQuery(
					"SELECT an_pic FROM campion.announcement WHERE an_no = " + an_no);
			
			if(rs.next()) {
				BufferedInputStream bInput= new BufferedInputStream(rs.getBinaryStream("an_pic"));
